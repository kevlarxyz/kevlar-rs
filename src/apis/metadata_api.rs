...
/// struct for typed errors of method [`erc721getmetadata`]
#[derive(Debug, Clone, serde::Serialize, serde::Deserialize)]

pub enum Erc721getmetadataError {
    UnknownValue(serde_json::Value),
}

pub async fn erc721getmetadata(
    configuration: &configuration::Configuration,
    account_name: &str,
    accept: &str,
) -> Result<String, Error<Erc721getmetadataError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str =
        format!("{}/accounts/{}/erc721/metadata", local_var_configuration.base_path, account_name);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<Erc721getmetadataError> =
