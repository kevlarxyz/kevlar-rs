...
/// struct for typed errors of method [`gettheconfiguration`]
#[derive(Debug, Clone, serde::Serialize, serde::Deserialize)]

pub enum GettheconfigurationError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`writeaconfiguration`]
#[derive(Debug, Clone, serde::Serialize, serde::Deserialize)]

pub enum WriteaconfigurationError {
    UnknownValue(serde_json::Value),
}

pub async fn gettheconfiguration(
    configuration: &configuration::Configuration,
    accept: &str,
    x_vault_request: &str,
    x_vault_token: &str,
) -> Result<String, Error<GettheconfigurationError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GettheconfigurationError> =
...
pub async fn writeaconfiguration(
    configuration: &configuration::Configuration,
    accept: &str,
    x_vault_request: &str,
    x_vault_token: &str,
    body: Option<&str>,
) -> Result<String, Error<WriteaconfigurationError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<WriteaconfigurationError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
