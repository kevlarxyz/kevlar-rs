...
/// struct for typed errors of method [`readbalance`]
...
pub async fn readbalance(
    configuration: &configuration::Configuration,
    account_name: &str,
    accept: &str,
    x_vault_request: &str,
    x_vault_token: &str,
) -> Result<String, Error<ReadbalanceError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str =
        format!("{}/accounts/{}/balance", local_var_configuration.base_path, account_name);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReadbalanceError> =
