...
/// struct for typed errors of method [`createanaccount`]
#[derive(Debug, Clone, serde::Serialize, serde::Deserialize)]

pub enum CreateanaccountError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`readanaccount`]
#[derive(Debug, Clone, serde::Serialize, serde::Deserialize)]

pub enum ReadanaccountError {
    UnknownValue(serde_json::Value),
}

pub async fn createanaccount(
    ...
    x_vault_token: &str,
    body: Option<&str>,
) -> Result<String, Error<CreateanaccountError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str =
        format!("{}/accounts/{}", local_var_configuration.base_path, account_name);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CreateanaccountError> =
...
pub async fn readanaccount(
    configuration: &configuration::Configuration,
    account_name: &str,
    accept: &str,
    x_vault_request: &str,
    x_vault_token: &str,
) -> Result<String, Error<ReadanaccountError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReadanaccountError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
