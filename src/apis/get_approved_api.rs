...
/// struct for typed errors of method [`erc721gettheapprovedaddressforasinglenft`]
#[derive(Debug, Clone, serde::Serialize, serde::Deserialize)]

pub enum Erc721gettheapprovedaddressforasinglenftError {
    UnknownValue(serde_json::Value),
}

pub async fn erc721gettheapprovedaddressforasinglenft(
    configuration: &configuration::Configuration,
    account_name: &str,
    accept: &str,
) -> Result<String, Error<Erc721gettheapprovedaddressforasinglenftError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!(
        "{}/accounts/{}/erc721/getApproved",
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<Erc721gettheapprovedaddressforasinglenftError> =
